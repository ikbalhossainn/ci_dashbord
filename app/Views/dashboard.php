...
<head>
    ...
    <link href="<?php echo site_url('assets/lib/tempusdominus/css tempusdominus-bootstrap-4.min.css')?>" rel="stylesheet" />
...
<body>
    ...
    <script src="<?php echo site_url('assets/lib/chart/chart.min.js')?>"></script>
    ...
    <script src="<?php echo site_url('assets/lib/tempusdominus/js/moment.min.js')?>"></script>
    <script src="<?php echo site_url('assets/lib/tempusdominus/js/moment-timezone.min.js')?>"></script>
    <script src="<?php echo site_url('assets/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js')?>"></script>
